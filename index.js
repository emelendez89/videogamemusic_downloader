...
var pageToVisit = "http://downloads.khinsider.com/game-soundtracks/album/the-legend-of-zelda-majora-s-mask-original-soundtrack";
var uniqueLinks = [];
...
request(pageToVisit, function (error, response, body) {
    if (!error && response.statusCode == 200) {
        ...
        var filtered = $(absoluteLinks).filter(function(){
            return pageToVisit == $(this).attr('href').substring(0,pageToVisit.length);
        });
